...
export const FilmIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="w-16 h-16 text-gray-500" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <rect width="18" height="18" x="3" y="3" rx="2" ry="2"></rect>
        <line x1="7" x2="7" y1="3" y2="21"></line>
        <line x1="17" x2="17" y1="3" y2="21"></line>
        <line x1="3" x2="21" y1="8" y2="8"></line>
...
export const RegenerateIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
        <path fillRule="evenodd" d="M4 2a1 1 0 011 1v2.101a7.002 7.002 0 0111.854 2.364A1 1 0 0116 8.364V6a1 1 0 01-2 0v2.364a5.002 5.002 0 00-9.854-2.364H6a1 1 0 01-2 0V3a1 1 0 011-1zm12 14a1 1 0 01-1-1v-2.101a7.002 7.002 0 01-11.854-2.364A1 1 0 014 9.636V12a1 1 0 012 0V9.636a5.002 5.002 0 009.854 2.364H14a1 1 0 012 0v2a1 1 0 01-1 1z" clipRule="evenodd" />
    </svg>
);
